...
inline void lzws_decompressor_initialize_alignment(lzws_decompressor_alignment_t* alignment_ptr, uint_fast8_t free_code_bit_length)
{
  alignment_ptr->free_code_bit_length = free_code_bit_length;
  alignment_ptr->source_byte_length   = 0;
}

inline void lzws_decompressor_add_source_byte_length_to_alignment(lzws_decompressor_alignment_t* alignment_ptr, uint_fast8_t source_byte_length)
{
...
inline bool lzws_decompressor_need_to_read_alignment(lzws_decompressor_alignment_t* alignment_ptr, uint_fast8_t free_code_bit_length)
{
...
inline void lzws_decompressor_reset_alignment_after_reading(lzws_decompressor_alignment_t* alignment_ptr, uint_fast8_t free_code_bit_length)
{
  alignment_ptr->free_code_bit_length = free_code_bit_length;
}
