...
extern inline bool          lzws_decompressor_has_symbol_in_dictionary_wrapper(lzws_decompressor_state_t* state_ptr);
extern inline uint8_t       lzws_decompressor_get_symbol_from_dictionary_wrapper(lzws_decompressor_state_t* state_ptr);
