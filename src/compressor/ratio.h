...
#if !defined(LZWS_COMPRESSOR_RATIO_H)
#define LZWS_COMPRESSOR_RATIO_H

#include "state.h"

// lzws_result_t lzws_compressor_initialize_ratio(lzws_compressor_state_t* state);
