...
enum {
  ...
  LZWS_COMPRESSOR_WRITE_DESTINATION_REMAINDER_BEFORE_READ_NEXT_SYMBOL,
  LZWS_COMPRESSOR_WRITE_DESTINATION_REMAINDER_BEFORE_CURRENT_CODE,
  LZWS_COMPRESSOR_WRITE_DESTINATION_REMAINDER_BEFORE_FLUSH_CURRENT_CODE,
  LZWS_COMPRESSOR_FLUSH_DESTINATION_REMAINDER,
  LZWS_COMPRESSOR_WRITE_PADDING_ZEROES_BEFORE_READ_NEXT_SYMBOL,
  LZWS_COMPRESSOR_WRITE_PADDING_ZEROES_BEFORE_CURRENT_CODE,
  LZWS_COMPRESSOR_WRITE_PADDING_ZEROES_BEFORE_FLUSH_CURRENT_CODE
};
