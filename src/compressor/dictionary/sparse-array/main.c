...
static inline size_t get_codes_length(lzws_compressor_dictionary_t* dictionary_ptr, size_t total_codes_length) {
  return (total_codes_length - dictionary_ptr->codes_length_offset) * LZWS_ALPHABET_LENGTH;
}
