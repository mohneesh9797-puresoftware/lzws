...
static inline size_t get_total_codes_length(lzws_compressor_dictionary_t* dictionary_ptr, uint_fast8_t max_code_bits) {
...
lzws_result_t lzws_compressor_allocate_dictionary(lzws_compressor_dictionary_t* dictionary_ptr, uint_fast8_t max_code_bits) {
  size_t total_codes_length = get_total_codes_length(dictionary_ptr, max_code_bits);
