...
extern inline void*              lzws_allocate_array(lzws_symbol_fast_t size_of_item, size_t length, const void* item_ptr, bool item_is_zero, bool item_bytes_are_identical);
